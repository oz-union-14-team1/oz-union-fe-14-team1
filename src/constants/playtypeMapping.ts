...
> = {
  ...
  RPG: { traits: ['story', 'immersive'], weight: 1 },
  시뮬레이션: { traits: ['strategic', 'freedom'], weight: 1 },
  퍼즐: { traits: ['strategic', 'casual'], weight: 1 },
  전략: { traits: ['strategic', 'challenging'], weight: 1 },
  인디: { traits: ['casual', 'creative'], weight: 1 },
  캐주얼: { traits: ['casual', 'peaceful'], weight: 1 },
  레이싱: { traits: ['fast', 'competitive'], weight: 1 },
  아케이드: { traits: ['fast', 'casual'], weight: 1 },
