...
export const MOCK_REVIEW_DETAIL: ReviewDetail = {
  ...
  rating: 4.7,
  like_count: 256,
  created_at: new Date('2025-01-20T09:18:00Z'),
  comments: [
    {
      id: 3001,
      author: {
      ...
      created_at: new Date('2025-01-20T10:01:00Z'),
    },
    {
      id: 3002,
      author: {
      ...
      created_at: new Date('2025-01-20T10:12:00Z'),
    },
    {
      id: 3003,
      author: {
      ...
      created_at: new Date('2025-01-20T10:30:00Z'),
    },
    {
      id: 3004,
      author: {
      ...
      created_at: new Date('2025-01-20T10:45:00Z'),
    },
    {
      id: 3005,
      author: {
      ...
      created_at: new Date('2025-01-20T11:05:00Z'),
    },
  ],
}
