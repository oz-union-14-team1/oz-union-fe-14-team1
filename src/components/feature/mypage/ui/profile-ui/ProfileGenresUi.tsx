...
type ProfileGenresUiProps = {
  genre: string
  variant?: 'main' | 'sub'
  className?: string
}

function ProfileGenresDesktopUi({
  genre,
  variant,
  className,
}: ProfileGenresUiProps) {
  return (
    <h1
      className={cn(
...
function ProfileGenresMobileUi({
  genre,
  variant,
  className,
}: ProfileGenresUiProps) {
...
export { ProfileGenresDesktopUi, ProfileGenresMobileUi }
