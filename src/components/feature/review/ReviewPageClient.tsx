...
import AsideContent from '@/components/feature/review/AsideContent'
...
export default function ReviewPageClient({ params }: ReviewPageClientProps) {
    ...
    <>
      <div className="flex w-full max-w-200 flex-col gap-5">
        <div className="flex w-full flex-col items-center">
          ...
          <aside className="mt-2 flex w-full max-w-200 flex-col gap-2 lg:hidden">
            <AsideContent game={game} review={review} />
          </aside>
        </div>
      ...
      <aside className="hidden w-80 flex-col gap-2 lg:sticky lg:top-25 lg:flex lg:self-start">
        <AsideContent game={game} review={review} />
      </aside>
    </>
  )
